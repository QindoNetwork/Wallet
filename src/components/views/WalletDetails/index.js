...
export class WalletDetails extends React.Component {
    ...
    tabs = [
        ...
        { id: 'network', label: 'Network', icon: 'contacts', content: <Groups navigation = {this.props.navigation} mnemonics = {this.props.navigation.getParam('mnemonics')} address = {this.props.navigation.getParam('address')} /> },
