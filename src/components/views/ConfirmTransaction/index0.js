        ...
        try {
            if(togethers) {
              if(crypto !== 0) {
                overrides = {
                    ...
                    gasPrice: gasParam[this.state.functionIndex2].price * conversions.gigaWeiToWei,
                    nonce: nonce,
                    //value: utils.parseEther('1.0'),
                    };
                const delay = await togethers.ERC20AllowanceExpiry()
                TransactionActions.erc20approve(this.state.value,ERC20s.type,nonce,ERC20s.instance,delay,overrides)
                nonce = nonce + 1
              }
              overrides = {
                  gasLimit: gasParam[this.state.functionIndex].limit,
                  gasPrice: gasParam[this.state.functionIndex].price * conversions.gigaWeiToWei,
                  nonce: nonce,
                  //value: utils.parseEther('1.0'),
                  };
            ...
            if(crypto !== 0) {
              overrides = {
                  ...
                  gasPrice: gasParam[this.state.functionIndex4].price * conversions.gigaWeiToWei,
                  //nonce: 123,
                  //value: utils.parseEther('1.0'),
                  };
              ...
              overrides = {
                  ...
                  gasPrice: gasParam[this.state.functionIndex3].price * conversions.gigaWeiToWei,
                  //nonce: 123,
                  //value: utils.parseEther('1.0'),
                  };
