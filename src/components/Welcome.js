...
this.setState({
      ...
      gasPrice: this.contracts["Togethers"].methods["gasPrice"].cacheCall({from: this.props.account}),
      dataKey1: this.contracts["Togethers"].methods["mappAddressToUser"].cacheCall(this.props.account),
      dataKey2: this.contracts["Togethers"].methods["getGroupsLength"].cacheCall({from: this.props.account}),
      dataKey3: this.contracts["TogethersCoin"].methods["balanceOf"].cacheCall(this.props.account),
                })
  }
  ...
  render() {
    ...
    if (
      !(
        ...
        &&
        this.state.gasPrice in
     this.props.contracts["Togethers"]["gasPrice"]
    ...
    var displayData3 = this.props.contracts["Togethers"]["gasPrice"][this.state.gasPrice].value;
...
<View style={styles.inputWrapper}>
        ...
        <TouchableOpacity
            ...
            <Text style={styles.label}>CHANGE ACCOUNT</Text>
        </TouchableOpacity>
        </View>
</View>
